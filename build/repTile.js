    ...
    var TilingManager = class {
        ...
        registerWindow(kwinWindow) {
            ...
            this._shouldWindowRegisterAsRoot(kwinWindow)
                ? this.registeredWindows.unshift(addedWindow)
        ...
        desktopChangedForWindow(kwinWindow) {
            ...
            this._shouldWindowRegisterAsRoot(kwinWindow)
                ? this.registeredWindows.unshift(registeredWindow)
                : this.registeredWindows.push(registeredWindow);
            this.logging.printMessage("-> window added to the Tiling Manager");
        ...
        _tileWindowsOnDesktop(desktop) {
            ...
            this.logging.printMessage(
                "-> tiling executed on Desktop: " + desktop
            );
        ...
        _getWindowsForDesktop(desktop) {
            ...
            this.registeredWindows.forEach((customWindow) => {
                if (
                    this.kwinWrapper.getWindowDesktop(
        ...
        _getWindowBelowTheWindow(movedWindow) {
            ...
            const midPointX =
                movedWindowPosition.x + movedWindowPosition.width / 2;
            const midPointY =
                    ...
                    if (
                        ...
                        midPointX <=
                            windowForDesktopPosition.x +
                                windowForDesktopPosition.width && // mid point Y is between the Windows Y and Y + Height
        ...
        _shouldWindowRegisterAsRoot(kwinWindow) {
            ...
            const shouldWindowRegisterAsRoot =
                registerAsRoot.indexOf(
                    ...
                    : false;
            this.logging.printMessage(
                "-> should Window Register As Root: " +
                    shouldWindowRegisterAsRoot
            );
        ...
        _getRegisteredWindowIndexById(id) {
            return this.registeredWindows.findIndex(
